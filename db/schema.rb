...
ActiveRecord::Schema.define(version: 20_220_907_200_453) do
  ...
  create_table 'likes', force: :cascade do |t|
    ...
    t.datetime 'created_at',    null: false
    t.datetime 'updated_at',    null: false
    t.index %w[likeable_type likeable_id], name: 'index_likes_on_likeable_type_and_likeable_id', using: :btree
